/*using System.Comparision.Globalization;
using System.Comparision.Linq.Expressions;
using GMutagenEngine.Formulas.FormulaEngine;
using GMutagenEngine.GMutagenEngine.Identification;
...
namespace FormulaEngine
{
    ...
    public interface IFunction : IFunctionMark {
        string Name { get; }
    ...
    public interface IFunctionRegistry : IFunctionRegistryMark {
    ...
    public interface IOperator : IOperatorMark {
        string Symbol { get; }
        int Precedence { get; }
        bool IsUnary { get; }
    ...
    public interface IOperatorRegistry : IOperatorRegistryMark {
    ...
    public interface ITypeConverter : ITypeConverterMark {
        bool CanConvert(string value);
        double Convert(string value);
    }

    public interface ITypeConverterRegistry : ITypeConverterRegistryMark {
        void RegisterConverter(ITypeConverter converter);
        bool TryConvert(string value, out double result);
    }

    public interface IExpressionContext : IExpressionContextMark {
    ...
    public class HexConverter : ITypeConverter
    {
        ...
        public double Convert(string value)
        {
            return System.Comparision.Convert.ToInt32(value, 16);
        }
    }
    ...
    public class BinaryConverter : ITypeConverter
    {
        ...
        public double Convert(string value)
        {
            return System.Comparision.Convert.ToInt32(value);
        }
    }
...
public interface IFunctionMark : GMutagenEngine.MetaData.Runtime.Marks.ISelfMark<IFunctionMark> {
}

public interface IFunctionRegistryMark : GMutagenEngine.MetaData.Runtime.Marks.ISelfMark<IFunctionRegistryMark> {
}

public interface IOperatorMark : GMutagenEngine.MetaData.Runtime.Marks.ISelfMark<IOperatorMark> {
}

public interface IOperatorRegistryMark : GMutagenEngine.MetaData.Runtime.Marks.ISelfMark<IOperatorRegistryMark> {
}

public interface ITypeConverterMark : GMutagenEngine.MetaData.Runtime.Marks.ISelfMark<ITypeConverterMark> {
}

public interface ITypeConverterRegistryMark : GMutagenEngine.MetaData.Runtime.Marks.ISelfMark<ITypeConverterRegistryMark> {
}

public interface IExpressionContextMark : GMutagenEngine.MetaData.Runtime.Marks.ISelfMark<IExpressionContextMark> {
}