    ...
    : System.Collections.IEqualityComparer
{
    ...
    private readonly IHashComputer _hashComputer = hashComputer ?? throw new ArgumentNullException(nameof(hashComputer));
 ...
 public class EqualityComparerAdapter<T>(
        ...
        : System.Collections.Generic.IEqualityComparer<T>
    {
        ...
        private readonly IHashComputer<T> _hashComputer = hashComputer ?? throw new ArgumentNullException(nameof(hashComputer));
    ...
    {
        private readonly IEqualityComparer<T1, T2> _comparer = comparer ?? throw new ArgumentNullException(nameof(comparer));
        private readonly IHashComputer<T1> _hashComputer1 = hashComputer1 ?? throw new ArgumentNullException(nameof(hashComputer1));
        private readonly IHashComputer<T2> _hashComputer2 = hashComputer2 ?? throw new ArgumentNullException(nameof(hashComputer2));
